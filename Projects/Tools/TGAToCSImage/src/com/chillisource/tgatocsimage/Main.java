...
public class Main 
{
	...
	private static void PrintHelpText()
	{
		...
		Logging.logVerbose("Usage: java -jar TGAToCSImage.jar --input <filename> --output <filename> [--convert <type>] [--convertalpha <type>] [--convertnoalpha <type>] [--compression <type>] [--disablepremultipliedalpha] [--dither] [" + Logging.k_paramLoggingLevel + " <level>] [--help]");
