...
namespace moFlo
{
    namespace AndroidPlatform
    {
		...
		FMOD_RESULT F_CALLBACK OnChannelAudioCompleteCallback(FMOD_CHANNEL* inpChannel, FMOD_CHANNEL_CALLBACKTYPE type, void *commanddata1, void *commanddata2)
		{
			switch(type)
			{
				case FMOD_CHANNEL_CALLBACKTYPE_END:
				{
					...
					moFlo::AndroidPlatform::CFMODAudioComponent* pAudioResource = NULL;
		...
		/// Default
		//---------------------------------------------------------------------
		CFMODAudioComponent::CFMODAudioComponent(Audio::IAudioSystem* inpOwningSystem) : Audio::CAudioComponent(inpOwningSystem), mpFMODChannel(NULL)
        {
        }
        //---------------------------------------------------------------------
		/// Play
