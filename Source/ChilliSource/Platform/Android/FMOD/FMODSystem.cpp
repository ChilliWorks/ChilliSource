...
namespace moFlo
{
	namespace AndroidPlatform
	{
		...
		/// Initialise FMOD
		//-------------------------------------------------------
		CFMODSystem::CFMODSystem() : IAudioSystem(), mpFMODSystem(NULL), mpFMODEventSystem(NULL), mpFMODEventProject(NULL)
		{
		...
		{
			MOFLOW_ASSERT(ineLocation != Core::SL_PACKAGE, "FMOD Android cannot load from package");
