...
/// native and java.
//=============================================================
public class CCoreNativeInterface extends INativeInterface implements ILaunchIntentReceiver
{	
	//--------------------------------------------------------------
	/// Static Member Data
	//--------------------------------------------------------------
	public static CInterfaceIDType InterfaceID = new CInterfaceIDType("CCoreNativeInterface");
	//--------------------------------------------------------------
	/// Member Data
	//--------------------------------------------------------------
	...
	/// Constructor
	//--------------------------------------------------------------
	public CCoreNativeInterface() throws NameNotFoundException
	{
	...
	{
		return CFileUtils.GetExternalStorageDirectory();
	}
	//--------------------------------------------------------------
