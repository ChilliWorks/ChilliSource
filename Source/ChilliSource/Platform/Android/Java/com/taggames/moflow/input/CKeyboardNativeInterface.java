...
import com.taggames.moflow.input.CNativeKeyboardInputView.KeyboardCapitalisation;
import com.taggames.moflow.input.CNativeKeyboardInputView.KeyboardType;
...
public class CKeyboardNativeInterface extends INativeInterface
{
	...
	/// Member data
	//-------------------------------------------------
	public static final CInterfaceIDType InterfaceID = new CInterfaceIDType("CKeyboardNativeInterface");
	private CNativeKeyboardInputView mKeyboardView = null;
	...
	/// Constructor
	//-------------------------------------------------
	public CKeyboardNativeInterface()
	{
	}
	//-------------------------------------------------
	/// Is A
	...
	{
		final CKeyboardNativeInterface thisKeyboardNativeInterface = this;
		...
		Runnable task = new Runnable() 
		{
			@Override public void run() 
			{
				...
				{
					mKeyboardView = new CNativeKeyboardInputView(mActivity, thisKeyboardNativeInterface, meKeyboardType, meKeyboardCapitalisation);
	...
	//-----------------------------------------------
	private CNativeKeyboardInputView.KeyboardType IntegerToKeyboardType(int indwKeyboardType)
	{
	...
	//-----------------------------------------------
	private CNativeKeyboardInputView.KeyboardCapitalisation IntegerToKeyboardCapitalisation(int indwKeyboardCapitalisation)
	{
