...
//============================================================
public class CPurchaseTransaction 
{
	//---------------------------------------------------
	/// Product Type
	//---------------------------------------------------
	...
	//---------------------------------------------------
	public CPurchaseTransaction(int indwResult, final String instrSKU, final ProductType ineProductType, final String instrTransactionID, final String instrPurchaseReceipt)
	{
