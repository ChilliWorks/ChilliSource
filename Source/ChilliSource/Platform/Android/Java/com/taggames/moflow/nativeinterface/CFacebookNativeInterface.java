...
public class CFacebookNativeInterface extends INativeInterface implements IActivityResults
{
	private static final CInterfaceIDType InterfaceID = new CInterfaceIDType("CFacebookNativeInterface");
	...
	{
		return inInterfaceType == CFacebookNativeInterface.InterfaceID;
	}
	//------------------------------------------------------
	/// On Activity Result
	///
    ...
    public void PublishInstall()
    {
		...
		{ 
			...
			{
		    	String strAppID = mActivity.getString(CMoFlowResourceHelper.GetDynamicResourceIDForField(mActivity, CMoFlowResourceHelper.RESOURCE_SUBCLASS.RESOURCE_STRING, "app_id"));
