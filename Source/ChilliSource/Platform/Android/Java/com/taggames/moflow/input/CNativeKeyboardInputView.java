...
//============================================================
public class CNativeKeyboardInputView extends View
{
	//------------------------------------------------------
	/// Keyboard Type
	///
	...
	CKeyboardNativeInterface mKeyboardNativeInterface = null;
	...
	//------------------------------------------------------
	public CNativeKeyboardInputView(CMoFlowActivity inActivity, CKeyboardNativeInterface inKeyboardNativeInterface, KeyboardType ineKeyboardType, KeyboardCapitalisation ineKeyboardCapitalisation) 
	{
		super(inActivity);
