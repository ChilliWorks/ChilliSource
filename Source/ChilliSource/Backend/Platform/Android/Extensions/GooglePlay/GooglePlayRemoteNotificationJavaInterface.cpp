...
namespace ChilliSource
{
    namespace Android
    {
		...
		{
			ChilliSource::Android::GooglePlayRemoteNotificationSystem* pRemoteNotificationSys = Core::Application::GetSystemImplementing<ChilliSource::Android::GooglePlayRemoteNotificationSystem>();
