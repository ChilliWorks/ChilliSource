...
namespace ChilliSource
{
	namespace Android
	{
		...
		private:
			friend Social::TwitterPostSystemUPtr Social::TwitterPostSystem::Create(Networking::HttpRequestSystem*);
            //----------------------------------------------------
            ...
            //----------------------------------------------------
            TwitterPostSystem(Networking::HttpRequestSystem* in_httpConnectionSystem);
			//------------------------------------------------------------------------
