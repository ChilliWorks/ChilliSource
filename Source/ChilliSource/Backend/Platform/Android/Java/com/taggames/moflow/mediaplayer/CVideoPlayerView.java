...
//========================================================
public class CVideoPlayerView extends SurfaceView implements OnPreparedListener, OnErrorListener, OnCompletionListener, SurfaceHolder.Callback
{	
	//------------------------------------------------------------------------
	/// Constants
	//------------------------------------------------------------------------
	...
	private CVideoPlayerActivity mActivity;
	private long mqwTapTime;
	//------------------------------------------------------------------------
	/// Constructor
	//------------------------------------------------------------------------
	public CVideoPlayerView(Context inContext, boolean inbInAPK, String instrFilename, boolean inbCanDismissWithTap, int indwSeekPosition) 
	{
		super(inContext);
		mActivity = CVideoPlayerActivity.GetActivity();
	...
	public void Dismiss() 
	{
		...
		Runnable task = new Runnable()
		{
			...
			{
				CVideoPlayerNativeInterface mediaPlayerNI = (CVideoPlayerNativeInterface)CNativeInterfaceManager.GetSingleton().GetNativeInterface(CVideoPlayerNativeInterface.InterfaceID);
		...
		CVideoPlayerActivity activity = null;
		synchronized (this)
		{
			activity = mActivity;
		}
	...
	public void OnBackPressed()
	{
		if (mbCanDismissWithTap == true)
		{
			CVideoPlayerNativeInterface videoPlayerNI = (CVideoPlayerNativeInterface)CNativeInterfaceManager.GetSingleton().GetNativeInterface(CVideoPlayerNativeInterface.InterfaceID);
