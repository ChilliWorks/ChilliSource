...
//=============================================================
public class CSubtitlesView extends ViewGroup
{	
	//----------------------------------------------------------
	/// Subtitle
	///
	...
	/// Member data
	//----------------------------------------------------------
	private CVideoPlayerNativeInterface mVideoPlayerNativeInterface = null;
	...
	/// Constructor
	//----------------------------------------------------------
	public CSubtitlesView(Context context) 
	{
		super(context);
		mVideoPlayerNativeInterface = (CVideoPlayerNativeInterface)CNativeInterfaceManager.GetSingleton().GetNativeInterface(CVideoPlayerNativeInterface.InterfaceID);
	...
	public long CreateSubtitle(String instrText, String instrFontName, int indwFontSize, String instrAlignment, float infX, float infY, float infWidth, float infHeight) 
	{
		...
		CVideoPlayerActivity.GetActivity().getWindowManager().getDefaultDisplay().getMetrics(metrics);
