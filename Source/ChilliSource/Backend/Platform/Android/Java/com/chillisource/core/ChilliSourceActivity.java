        ...
        runOnUiThread(new Runnable() 
        {
        	public void run()
        	{
        		...
        		.setPositiveButton(instrConfirm, new DialogInterface.OnClickListener() 
        		{
        			...
        			{
        				((CoreNativeInterface)NativeInterfaceManager.GetSingleton().GetNativeInterface(CoreNativeInterface.InterfaceID)).OnDialogConfirmed(indwDialogID);
        			}
        		})
        		.setNegativeButton(instrCancel,new DialogInterface.OnClickListener() 
        		{
        			@Override public void onClick(DialogInterface dialog, int which) 
        			{
        				((CoreNativeInterface)NativeInterfaceManager.GetSingleton().GetNativeInterface(CoreNativeInterface.InterfaceID)).OnDialogCancelled(indwDialogID);
        			}
        		})
        		.show();
        	}
