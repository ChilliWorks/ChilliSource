...
namespace ChilliSource
{
	namespace Windows
	{
		...
		void PngImage::Load(Core::StorageLocation ineLocation, const std::string& instrFilename)
		{
			...
			ChilliSource::Core::FileStreamSPtr stream = ChilliSource::Core::Application::Get()->GetFileSystemPtr()->CreateFileStream(ineLocation, instrFilename, ChilliSource::Core::FileMode::k_readBinary);
