...
@interface GKAchievementNotification(internal)
...
@implementation GKAchievementNotification(internal)
...
- (void)animateIn
{
    ...
    self.frame = [self getAchievementEndFrame];
...
- (void)animateOut
{
    ...
    self.frame = [self getAchievementStartFrame];
    [UIView commitAnimations];
}
