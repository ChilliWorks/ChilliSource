...
#define kGKAchievementDisplayTime   2.5f

#define kGKAchievementDefaultSize   CGRectMake(0.0f, 0.0f, 284.0f, 52.0f);

#define kGKAchievementText1         CGRectMake(10.0f, 6.0f, 264.0f, 22.0f);
#define kGKAchievementText2         CGRectMake(10.0f, 20.0f, 264.0f, 22.0f);
#define kGKAchievementText1WLogo    CGRectMake(45.0f, 6.0f, 229.0f, 22.0f);
#define kGKAchievementText2WLogo    CGRectMake(45.0f, 20.0f, 229.0f, 22.0f);
