...
public:
	...
	*/
#ifdef TIXML_MOFLO
	virtual void Print( moFlo::Core::FileStreamPtr cfile, int depth ) const = 0;
#else
...
#ifdef TIXML_MOFLO
	virtual void Print( moFlo::Core::FileStreamPtr cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
	void Print( moFlo::Core::FileStreamPtr cfile, int depth, TIXML_STRING* str ) const;
#else
...
#ifdef TIXML_MOFLO
	virtual void Print( moFlo::Core::FileStreamPtr cfile, int depth, TIXML_STRING* str ) const;
	virtual void Print( moFlo::Core::FileStreamPtr cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
#else
...
#ifdef TIXML_MOFLO
	virtual void Print( moFlo::Core::FileStreamPtr cfile, int depth = 0 ) const;
#else
