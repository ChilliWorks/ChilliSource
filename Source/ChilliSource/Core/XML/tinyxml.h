...
/*
 Ammended by Ian Copland on 29/03/11 for cross platform use within Tag Game's Moflo engine.
 */
...
//I.C - undefine this to return to non-moFlo use of TinyXML. 
//		Note: While TIXML_MOFLO is defined, TIXML_USE_STL MUST be defined.
#define TIXML_MOFLO
...
/** TiXmlBase is a base class   for every class   in TinyXml.
	It does little except to establish that TinyXml class  es
...
public:
	...
	/**	All TinyXml class  es can print themselves to a filestream
	...
	*/
#ifdef TIXML_MOFLO
	virtual void Print( ChilliSource::Core::FileStreamPtr cfile, int depth ) const = 0;
#else
...
public:
	...
	*/
	...
	/** The meaning of 'value' changes for the specific type of
		...
		The subclass  es will wrap this function.
	*/
...
#ifdef TIXML_MOFLO
	virtual void Print( ChilliSource::Core::FileStreamPtr cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
	void Print( ChilliSource::Core::FileStreamPtr cfile, int depth, TIXML_STRING* str ) const;
#else
...
/*	A class   used to manage a group of attributes.
	...
	class  es that use it, but NOT transparent to the Attribute
...
#ifdef TIXML_MOFLO
	virtual void Print( ChilliSource::Core::FileStreamPtr cfile, int depth, TIXML_STRING* str ) const;
	virtual void Print( ChilliSource::Core::FileStreamPtr cfile, int depth ) const {
		Print( cfile, depth, 0 );
	}
#else
...
public:
	...
	bool LoadFile( ChilliSource::Core::FileStreamPtr file, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	bool SaveFile(ChilliSource::Core::FileStreamPtr file);
#else
...
#ifdef TIXML_MOFLO
	void Print() const						{ /*Print( stdout, 0 );*/ } //This wont work with the moFlo implementation
#else
...
#ifdef TIXML_MOFLO
	virtual void Print( ChilliSource::Core::FileStreamPtr cfile, int depth = 0 ) const;
#else
