...
namespace ChilliSource
{
    namespace Core
    {
        ...
        //-------------------------------------------------------------
        u32 CHashCRC32::GenerateHashCode(const std::string &instrVal)
        {
        ...
        /// @return CRC 32 hash code
        //-------------------------------------------------------------
        u32 CHashCRC32::GenerateHashCode(const s8* instrVal)
        {
        ...
        /// @return CRC 32 hash code
        //-------------------------------------------------------------
        u32 CHashCRC32::GenerateHashCode(const s8* inbyVal, u32 inudwSizeInBytes)
        {
            u32 Result = 0xffffffff;
