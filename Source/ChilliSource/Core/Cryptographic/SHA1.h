...
#ifndef __MO_FLO_CORE_CRYPTOGRAPHIC_SHA1_H__
#define __MO_FLO_CORE_CRYPTOGRAPHIC_SHA1_H__
...
#ifdef SHA1_UTILITY_FUNCTIONS
			void ReportHash(char *szReport, ReportType eReportType = REPORT_HEX);
#endif
			void GetHash(u8 *puDest);
            
            std::string GetHash(ReportType ineType);
...
#endif // __MO_FLO_CORE_CRYPTOGRAPHIC_SHA1_H__
