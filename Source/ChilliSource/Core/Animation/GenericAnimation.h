...
namespace ChilliSource
{
    namespace Core
    {
        ...
        public:
            ...
            typedef std::function<void(Animation*)> OnCompleteDelegate;
            typedef std::function<void(Animation*)> OnStartDelegate;
        ...
        public:
            ...
            virtual ~KeyframeAnimation()
            {
                if (mbOwnsData)
                {
                    CS_SAFEDELETE(mpafKeyframeTimes);
                    CS_SAFEDELETE(mpaKeyValues);
                }
            }
