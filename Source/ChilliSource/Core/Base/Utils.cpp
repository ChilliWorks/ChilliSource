...
namespace ChilliSource
{
    namespace Core
    {
        namespace Utils
        {
            ...
            {
                FileStreamSPtr pFile = Application::Get()->GetFileSystemPtr()->CreateFileStream(ineStorageLocation, instrPath, FileMode::k_read);
            ...
            {
                FileStreamSPtr pFile = Application::Get()->GetFileSystemPtr()->CreateFileStream(ineStorageLocation, instrPath, FileMode::k_write);
