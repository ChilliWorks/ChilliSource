...
namespace ChilliSource
{
	namespace GUI
	{
        ...
        /// @param Texture
        //------------------------------------------------------------------------
        void HorizontalEndcappedProgressBar::SetTexture(const Rendering::TextureSPtr& inpTexture)
        {
            Texture = inpTexture;
        ...
        /// @return Texture
        //------------------------------------------------------------------------
        const Rendering::TextureSPtr& HorizontalEndcappedProgressBar::GetTexture() const
        {
            return Texture;
        }
		//------------------------------------------------------------------------
