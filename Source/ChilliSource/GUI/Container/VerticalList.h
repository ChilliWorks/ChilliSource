...
#ifndef _CHILLISOURCE_GUI_VERTICAL_LIST_H_
#define _CHILLISOURCE_GUI_VERTICAL_LIST_H_
...
namespace ChilliSource
{
    namespace GUI
    {
        class VerticalList : public GUIView
        {
        public:
            
            DECLARE_META_CLASS(VerticalList)
            
            VerticalList();
            VerticalList(const Core::ParamDictionary& insParams);
        ...
        private:
            ...
            Rendering::AlignmentAnchor meHorizontalAlignmentAnchor;
