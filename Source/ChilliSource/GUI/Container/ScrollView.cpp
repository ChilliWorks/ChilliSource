    ...
    namespace GUI
    {
        ...
        void ScrollView::Update(f32 infDt)
        {
            if(Visible)
            {
				...
				//Get edge positions
				Core::Vector2Old vTopLeft = GetAbsoluteScreenSpaceAnchorPoint(Rendering::AlignmentAnchor::k_topLeft);
				Core::Vector2Old vBottomRight = GetAbsoluteScreenSpaceAnchorPoint(Rendering::AlignmentAnchor::k_bottomRight);
				...
				Core::Vector2Old vNewLeftPosition = mvVelocity + mpContainerView->GetAbsoluteScreenSpaceAnchorPoint(Rendering::AlignmentAnchor::k_topLeft);
				Core::Vector2Old vNewRightPosition = mvVelocity + mpContainerView->GetAbsoluteScreenSpaceAnchorPoint(Rendering::AlignmentAnchor::k_bottomRight);
				
				Core::Vector2Old vSizeOfContainer = mpContainerView->GetAbsoluteScreenSpaceAnchorPoint(Rendering::AlignmentAnchor::k_topRight) - mpContainerView->GetAbsoluteScreenSpaceAnchorPoint(Rendering::AlignmentAnchor::k_bottomLeft);
				...
				{
					mvVelocity = Core::Vector2Old::ZERO;
				}
        ...
        {
            mvVelocity = Core::Vector2Old::ZERO;
            mpContainerView->SetOffsetFromParentAlignment(Core::UnifiedVector2Old(Core::Vector2Old::ZERO, Core::Vector2Old::ZERO));
        }
        //-----------------------------------------------------
        /// Jump To
        ///
        ...
        //-----------------------------------------------------
        void ScrollView::JumpTo(const Core::UnifiedVector2Old& inuvPosition)
        {
            Reset();
            Core::Vector2Old vAbsPos = inuvPosition.GetAbsolute() + (inuvPosition.GetRelative()*mpContainerView->GetAbsoluteSize());
        ...
        /// @param Content size
        //-----------------------------------------------------
        void ScrollView::SetAbsoluteContentSize(const Core::Vector2Old& invSize)
        {
        ...
        /// @return Content size
        //-----------------------------------------------------
        Core::Vector2Old ScrollView::GetAbsoluteContentSize() const
        {
            if(!mpContainerView)
                return Core::Vector2Old::ZERO;
        ...
        //-----------------------------------------------------------
        Core::Vector2Old ScrollView::GetAbsoluteContentPosition() const
        {
            if(!mpContainerView)
                return Core::Vector2Old::ZERO;
        ...
        /// @param Velocity
        //-----------------------------------------------------
        void ScrollView::SetVelocity(const Core::Vector2Old& invVelocity)
        {
