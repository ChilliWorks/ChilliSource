...
namespace ChilliSource
{
    namespace GUI
    {
        ...
        HorizontalSliderBar::HorizontalSliderBar() : mpBackgroundImage(new ImageView()), mpSliderImage(new ImageView()), UnifiedSliderSize(0.15f, 1.5f, 0.0f, 0.0f)
        {
            ...
            mpSliderImage->SetSize(Core::UnifiedVector2Old(Core::Vector2Old(0.15f, 1.5f), Core::Vector2Old(0, 0)));
            mpSliderImage->SetPosition(Core::UnifiedVector2Old(Core::Vector2Old(0.0f, 0.5f), Core::Vector2Old(0, 0)));
		...
		//--------------------------------------------------------
		void HorizontalSliderBar::SetSliderSize(const Core::UnifiedVector2Old& invUnifiedSize)
		{
		...
		//--------------------------------------------------------
		const Core::UnifiedVector2Old& HorizontalSliderBar::GetSliderSize() const
		{
