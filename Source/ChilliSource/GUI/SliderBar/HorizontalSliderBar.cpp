...
namespace ChilliSource
{
    namespace GUI
    {
        ...
        //--------------------------------------------------------
        void HorizontalSliderBar::SetBarTexture(const Rendering::TextureSPtr& inpTexture)
        {
        ...
        //--------------------------------------------------------
        void HorizontalSliderBar::SetSliderTexture(const Rendering::TextureSPtr& inpTexture)
        {
