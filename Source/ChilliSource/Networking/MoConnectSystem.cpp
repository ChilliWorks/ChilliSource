...
namespace moFlo
{
	...
	namespace Networking
    {
        ...
        /// Constructor
        //------------------------
		CMoConnectSystem::CMoConnectSystem(IHttpConnectionSystem* inpHttpSystem, const std::string& instrMoConnectServerURL, COAuthSystem* inpOAuthSystem)
        ...
        /// Get OAuth System
        //------------------------
        COAuthSystem* CMoConnectSystem::GetOAuthSystem()
        {
