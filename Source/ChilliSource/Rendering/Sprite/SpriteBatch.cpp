...
#endif
                m_renderSystem->RenderBuffer(mpSpriteBuffer, inudwOffset, inudwStride, Core::Matrix4x4Old::IDENTITY);
            }
		}
        //------------------------------------------------------
		/// Render
...
#endif
                m_renderSystem->RenderBuffer(mpSpriteBuffer, 0, mpSpriteBuffer->GetIndexCount(), Core::Matrix4x4Old::IDENTITY);
            }
		}
		//------------------------------------------------------
		/// Get Tag
