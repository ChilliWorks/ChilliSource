...
namespace ChilliSource
{
    namespace Rendering
    {
        ...
        public:
			...
			//----------------------------------------------------------
			void BuildMatrices(s32 indwCurrentParent = -1, const Core::Matrix4x4Old& inParentMatrix = Core::Matrix4x4Old());
            //----------------------------------------------------------
			/// Get Matrix At Index
            ///
            ...
            /// @return the matrix.
			//----------------------------------------------------------
            const Core::Matrix4x4Old& GetMatrixAtIndex(s32 indwIndex) const;
            //----------------------------------------------------------
			...
			//----------------------------------------------------------
			void ApplyInverseBindPose(const std::vector<Core::Matrix4x4Old>& inInverseBindPoseMatrices, std::vector<Core::Matrix4x4Old>& outCombinedMatrices);
            //----------------------------------------------------------
        ...
        private:
            ...
            std::vector<Core::Matrix4x4Old> mCurrentAnimationMatrices;
