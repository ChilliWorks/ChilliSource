...
#include <ChilliSource/Rendering/GUI/GridView.h>
...
bool ChilliSource::CGridView::mbDrawDebug = false;
...
namespace ChilliSource
{
    namespace Rendering
    {
...
#if DEBUG_DRAWING
				if(ChilliSource::CGridView::mbDrawDebug)
				{
		...
		{
#if DEBUG_DRAWING
			ChilliSource::CGridView::mbDrawDebug = inbValue;
#else
			ChilliSource::CGridView::mbDrawDebug = false;
#endif
		}
    }
}
