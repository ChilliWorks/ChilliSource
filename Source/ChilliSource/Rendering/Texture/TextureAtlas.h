...
namespace ChilliSource
{
	namespace Rendering
	{
		...
		public:
            ...
            ///
			/// @return Frame data at index
			//---------------------------------------------------------------------
			const Frame& GetFrame(u32 in_frameIndex) const;
            //---------------------------------------------------------------------
            /// @author S Downie
            ///
            /// @param Texture Id as generated by the sprite tool
            ///
            /// @return Index of frame (assert if not found)
            //---------------------------------------------------------------------
            u32 GetFrameIndexById(const std::string& in_textureId) const;
            //---------------------------------------------------------------------
            /// @author S Downie
            ///
            /// @param Texture Id as generated by the sprite tool
			...
			//---------------------------------------------------------------------
			Core::Rectangle GetFrameUVs(u32 in_frameIndex) const;
			//---------------------------------------------------------------------
			/// @author S Downie
			///
			/// @param Frame index
			...
			//---------------------------------------------------------------------
			Core::Vector2 GetFrameSize(u32 in_frameIndex) const;
			//---------------------------------------------------------------------
			/// @author S Downie
			///
			/// @param Frame index
            ...
            /// sprite.
			//---------------------------------------------------------------------
			Core::Vector2 GetFrameOffset(u32 in_frameIndex) const;
			//---------------------------------------------------------------------
            /// @author S Downie
			///
