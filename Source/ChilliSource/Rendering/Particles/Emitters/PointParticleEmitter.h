...
namespace moFlo
{
    namespace Rendering
    {
        class CPointParticleEmitter : public CParticleEmitter
        {
        public:
            CPointParticleEmitter(const Core::ParamDictionary& inParams, const MaterialPtr &inpMaterial, CParticleComponent* inpComponent);
