...
namespace ChilliSource
{
	namespace Rendering
	{
        ...
        CS_FORWARDDECLARE_CLASS(MeshFeatureDescriptor);
        CS_FORWARDDECLARE_CLASS(SubMeshDescriptor);
        CS_FORWARDDECLARE_CLASS(MeshDescriptor);
        ...
        CS_FORWARDDECLARE_CLASS(SkinnedAnimationFrame);
        CS_FORWARDDECLARE_CLASS(SkeletonNode);
        ...
        /// Particles
        //------------------------------------------------------------
        CS_FORWARDDECLARE_CLASS(Particle);
