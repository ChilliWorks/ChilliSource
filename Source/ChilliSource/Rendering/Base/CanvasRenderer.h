...
namespace ChilliSource
{
	namespace Rendering
	{
		...
		private:
			...
			//-----------------------------------------------------
			void UpdateSpriteData(const Core::Matrix4x4Old& inTransform, const Core::Vector2 & invSize, const Core::Rectangle& inUVs, const Core::Colour & insTintColour, AlignmentAnchor ineAlignment);
